...
class NextViewController: UIViewController {
    ...
    var autoUpdateTextValue: String?
    var updateIntervalTextValue: String?
    ...
    func setupValue() {
        if let emailTextValue = emailTextValue {
            emailText.text = emailTextValue
        }
        if let autoUpdateTextValue = autoUpdateTextValue {
            autoUpdateText.text = autoUpdateTextValue
        }
        
        if let updateIntervalTextValue = updateIntervalTextValue {
            updateIntervalText.text = updateIntervalTextValue
        }
    }
